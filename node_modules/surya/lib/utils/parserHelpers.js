...
var parserHelpers = {
  isRegularFunctionCall: function isRegularFunctionCall(node, contractNames, eventNames, structNames, customErrorNames) {
    var expr = node.expression;
    return expr && expr.type === 'Identifier' && !contractNames.includes(expr.name) && !eventNames.includes(expr.name) && !structNames.includes(expr.name) && !customErrorNames.includes(expr.name) && !BUILTINS.includes(expr.name);
  },
